locals {
  express_route_circuits = { for k1, v1 in var.express_route_circuits : k1 => { allow_classic_operations = v1.allow_classic_operations, authorization_key = v1.authorization_key, authorization_key_key_vault_id = v1.authorization_key_key_vault_id, authorization_key_key_vault_secret_name = v1.authorization_key_key_vault_secret_name, bandwidth_in_gbps = v1.bandwidth_in_gbps, bandwidth_in_mbps = v1.bandwidth_in_mbps, express_route_port_id = v1.express_route_port_id, location = v1.location, name = v1.name, peering_location = v1.peering_location, rate_limiting_enabled = v1.rate_limiting_enabled, resource_group_name = v1.resource_group_name, service_provider_name = v1.service_provider_name, sku = v1.sku, tags = v1.tags } }
